...
//                    }
    ...
    public static String getPrefix() {
        if (PropertiesComponent.getInstance().isValueSet(CreateViewHolderConfig.PREFIX)) {
            return PropertiesComponent.getInstance().getValue(CreateViewHolderConfig.PREFIX);
        } else {
